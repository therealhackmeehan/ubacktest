        ...
        <div className='mt-16 max-w-7xl mx-auto my-auto'>
            <div className="mx-3 md:mx-8 pb-24">
                ...
                <div className="md:grid grid-cols-4 dark:text-white">
                    <div className="m-4 p-1 md:p-4 col-span-2 bg-slate-100 dark:bg-boxdark-2 rounded-xl">
                        <h4 className='my-2 font-bold tracking-tight text-gray-900 sm:text-3xl text-xl dark:text-white text-center'>
                            About Us
                        </h4>
                        <div className="text-sm md:text-lg font-normal m-3 text-center">
                    ...
                    <div className="m-4 p-1 md:p-4 col-span-2 bg-slate-100 dark:bg-boxdark-2 rounded-xl flex flex-col justify-between">
                        <div>
                            <h4 className='my-2 font-bold tracking-tight text-gray-900 sm:text-3xl text-xl dark:text-white text-center'>
                                Contact Us
                            </h4>
                        ...
                        <div className="text-center text-xl">📩 Contact us at <a href="mailto:support@uBacktest.com" className="font-bold hover:font-extrabold hover:underline">support@uBacktest.com</a>.</div>
                    </div>
                </div>
            </div>
        </div>
