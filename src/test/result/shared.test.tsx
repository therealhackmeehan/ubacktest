...
const noShareMessage = "No results found. If someone were to share a result with you, it would appear here.";
const sharedUserName = mockUser.email?.split('@')[0] ?? "unknown";
const sharedTextRegex = new RegExp(`@${sharedUserName}\\s+sent you a result`, 'i');
