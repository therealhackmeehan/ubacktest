...
function LeaderboardItem({ result, index }: LeaderboardItemProps) {
    ...
    return (
        <>
            <div
                ref={ref}
                className={`border-l-8 border-sky-700 dark:border-blue-300 rounded-md my-2 bg-white p-2 justify-between flex duration-700 dark:bg-black`}
                style={{
            ...
            >
                ...
                <div className='font-bold text-xs text-end tracking-tight flex gap-x-3 justify-end'>
                    <div className='p-2 m-1 text-sky-700 dark:text-blue-300'>@{result.email.split('@')[0]}</div>
