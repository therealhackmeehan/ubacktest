  ...
  return (
    <div className='relative'>
      <button
        ...
        className='flex items-center gap-4 duration-300 ease-in-out text-gray-900 hover:text-slate-500'
      >
      ...
      <div
        ref={dropdown}
        className={cn(
          'z-50 absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:text-white',
          {
            hidden: !dropdownOpen,
          }
        )}
