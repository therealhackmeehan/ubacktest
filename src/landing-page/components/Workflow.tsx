        ...
        <div className='mx-auto mt-16 max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl text-center'>
                <p className='mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl dark:text-white'>
                    Welcome to <span className='text-sky-700 dark:text-sky-500'>uBacktest</span>.
                </p>
            ...
            <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl'>
                <div className="lg:grid grid-cols-3 gap-4">
                    {/* Step 1 */}
                    <div ref={ref1} className={`m-2 col-span-2 flex border-sky-700 rounded-md border-2 transition-transform duration-1000 transform ${inView1 ? 'translate-x-0' : '-translate-x-full'}`}>
