        ...
        <div className='mx-auto mt-16 max-w-7xl px-6 lg:px-8'>
            ...
            <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl'>
                <div className="lg:grid grid-cols-3 gap-8">
                    {/* Step 1 */}
                    <div ref={ref1} className={`col-span-2 flex border-sky-700 rounded-md border-2 transition-transform duration-1000 transform ${inView1 ? 'translate-x-0' : '-translate-x-full'}`}>
                        <div className="bg-sky-700 text-white px-3 font-bold text-title-xl">1</div>
                        <div className="p-2 w-full">image here</div>
                    </div>
                    ...
                    <div ref={ref2} className={`col-span-2 flex justify-start gap-x-2 transition-transform duration-1000 transform ${inView2 ? 'translate-x-0' : '-translate-x-full'}`}>
                        <div className="rounded-md bg-sky-700 hue-rotate-15 text-white px-3 font-bold text-title-xl">2</div>
                        <div className="border-2 border-slate-800 p-2 rounded-md w-full">image here</div>
                    </div>
                    ...
                    <div ref={ref3} className={`col-span-2 flex justify-start gap-x-2 transition-transform duration-1000 transform ${inView3 ? 'translate-x-0' : '-translate-x-full'}`}>
                        <div className="rounded-md bg-sky-700 -hue-rotate-15 text-white px-3 font-bold text-title-xl">3</div>
                        <div className="border-2 border-slate-800 p-2 rounded-md w-full">image here</div>
                    </div>
                    ...
                    <div ref={ref4} className={`col-span-2 flex justify-start gap-x-2 transition-transform duration-1000 transform ${inView4 ? 'translate-x-0' : '-translate-x-full'}`}>
                        <div className="rounded-md bg-sky-800 text-white px-3 font-bold text-title-xl">4</div>
                        <div className="border-2 border-slate-800 p-2 rounded-md w-full">image here</div>
                    </div>
                    <div className="col-span-1 bg-slate-100 rounded-lg p-4 bg-gradient-to-bl from-sky-600/10 to-slate-100 dark:text-slate-800">
