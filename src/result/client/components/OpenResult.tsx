    ...
    <>
      ...
      {strategyResult && statResult && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div
            className="fixed inset-0 w-full bg-gray-800 opacity-50"
          ...
          <div className="z-10 w-11/12 h-5/6 p-4 bg-white border-2 border-black rounded-lg shadow-xl overflow-y-auto">
            <button
              onClick={() => setResultPanelOpen(false)}
              className="flex justify-between items-center text-xs mx-auto gap-x-40 text-center p-1 text-red-500 border-2 border-red-200 rounded-md hover:font-extrabold hover:bg-red-100 hover:text-red-400"
            >
              Close
              <TiCancel />
            </button>
            ...
            <div
              ...
              className="px-8 mx-auto min-w-187.5"
            >
              <textarea
                ...
                readOnly
              />
              <div className="text-xs font-extrabold text-end -translate-y-8 -translate-x-8">
                Click to copy
              </div>
