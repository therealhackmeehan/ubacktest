...
export const weeklyPackageUpdate: WeeklyPackageUpdate<{}, string> = async (_args, context) => {
    ...
    console.log("successfully updated package details at " + packageInfoEntry.date);
