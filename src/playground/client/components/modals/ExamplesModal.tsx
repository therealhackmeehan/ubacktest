  ...
  return (
    <ModalLayout closeModal={closeModal}>
      <div className="flex justify-between mb-4">
        <h2 className="text-sky-700 dark:text-blue-300 font-semibold">
          Import an Example{" "}
          <span className="text-slate-800 dark:text-white">Strategy</span>
        </h2>
      ...
      <div className="font-mono text-xs text-center mt-2 dark:text-red-100">
        Please note that importing an example will completely erase any code
        that you may have attached to this strategy.
      </div>
