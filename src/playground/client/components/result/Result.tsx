...
function Result({
  ...
  const [userDefinedPlotOpen, setUserDefinedPlotOpen] =
  ...
  return (
    <>
      ...
      <div className="relative px-0 md:px-12 lg:px-24 bg-white min-w-187.5">
        ...
        <div
          id="topOfResultPanel"
          className="items-center flex p-2 justify-between border-b-2 border-black"
        >
          ...
          <ResultButtonGroup
            ...
            saveAsPDF={saveAsPDF}
            abilityToSaveNew={abilityToSaveNew}
        ...
        <div className="m-8">
          <div className="flex justify-between">
            ...
            <div className="font-extrabold text-xs text-sky-700/50">
              scroll to zoom. click to reset.
            </div>
          </div>
          <CandlePlot
            strategyResult={strategyResult}
            costPerTrade={formInputs.costPerTrade}
            symbol={formInputs.symbol}
          />
        ...
        <div className="grid grid-cols-3 gap-x-6 justify-stretch m-8">
          ...
          <div className="col-span-2 bg-slate-100 rounded-lg max-h-132.5 overflow-y-auto shadow-sm border-2 border-slate-300">
            <div className="flex justify-between m-2">
              <div className="text-sky-700 font-extrabold tracking-tight text-lg">
                Trade Log
              </div>
              <button
        ...
        <div className="flex justify-between m-2 pb-8">
          <button
            className="flex p-2 rounded-md hover:bg-slate-100"
            onClick={() =>
              document
                .getElementById("topOfResultPanel")
      ...
      {!isFirefox && (
        ...
        >
          ...
          <div className="m-8">{stats && <MainStatistics stats={stats} />}</div>
