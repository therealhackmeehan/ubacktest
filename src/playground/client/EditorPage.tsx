    ...
    return (
        ...
        <div className='w-full h-screen grid grid-cols-[min-content_auto] border-t-2 border-black'>
            ...
            <div className="flex overflow-x-hidden">
                <div className="h-full bg-gray-50 dark:bg-boxdark overflow-y-auto"
...
function NoStrategiesBanner({ isStrategiesLoading }: { isStrategiesLoading: boolean }) {
    return (
        <div className="overflow-y-hidden h-screen bg-blue-300/10">
            <div className="border-2 p-4 rounded-xl border-black font-extrabold mt-12 mx-4 justify-self-center text-3xl text-slate-800/30 tracking-tight dark:text-white dark:border-white">
