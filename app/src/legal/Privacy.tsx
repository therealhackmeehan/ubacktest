  ...
  return (
    <ContentWrapper>
      ...
      <div className="mt-12 max-w-5xl dark:text-white">
        ...
        <p>
          Meehan Software Group (“we,” “us,” or “our”) operates the uBacktest
          platform. This Privacy Policy is intended to inform you (“you” or “the
          user”) about how we collect, use, disclose, and protect your personal
          data when you use our backtesting service, as well as the rights and
        ...
        <p>
          ...
          <br />
          <a
            href="mailto:info@meehansoftware.com"
        ...
        <p className="mt-2 text-sm italic">
          Note: All payment transactions are securely processed through our
        ...
        <p className="font-semibold mt-4">
          To Provide Our Backtesting Services
        </p>
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            Generate Python code for strategy deployment in simulated (paper)
            trading
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            <strong>Backtesting Strategies and Results:</strong> Retained while
            your account is active or until deleted by you
          </li>
          <li>
            <strong>Payment Records:</strong> Retained for the duration required
        ...
        <p className="mt-2">
          ...
          authority if you believe our data processing practices violate
          applicable laws.
        </p>
        ...
        <p>
          We share your data only as necessary, and only with trusted third
          parties, including:
        </p>
        <ul className="list-disc list-inside ml-4">
          <li>
            <strong>Stripe</strong> – For secure payment processing. Stripe is
            contractually obligated to protect your personal data.
            <br />
            <a
        ...
        <p>
          ...
          our site. Google Analytics uses cookies — small text files stored on
          your device — to collect anonymous visitor behavior data. This data is
          transmitted to and stored by Google on servers in the United States.
        </p>
        <p className="mt-2">
          We use this data to improve website performance, user experience, and
          our service offerings. Google may process this data in accordance with
        ...
        <p className="mt-2">
          By using our website, you consent to the use of cookies and Google
          Analytics as described above. We also use cookies for secure session
          management — these are cleared when you log out or close your browser.
        </p>

        <h5 className="font-semibold text-lg mb-4 mt-8">10. Data Security</h5>
        <p>
          We take appropriate technical and organizational measures to protect
          your personal data against unauthorized access, disclosure, or
          destruction.
        </p>
