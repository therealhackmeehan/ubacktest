  ...
  return (
    <div className="mt-35 max-w-4xl mx-auto px-6">
      <div className="flex justify-between m-4 lg:m-8 items-center">
        <div className="text-title-xl2 text-sky-700 dark:text-blue-300 tracking-tight font-bold">
          uBacktest.
        </div>
      ...
      <div className="overflow-hidden border border-gray-900/10 shadow-lg sm:rounded-lg mb-4 lg:m-8 dark:border-gray-100/10">
        <div className="px-4 py-5 sm:px-6 lg:px-8">
          <h3 className="text-xl font-semibold leading-6 text-sky-800 dark:text-white">
            Account Information
          </h3>
        </div>
...
function BuyMoreButton() {
  return (
    <div className="ml-4 flex-shrink-0 sm:col-span-1 sm:mt-0">
      <Link
        to="/pricing"
        className="font-medium text-sm text-sky-500 dark:text-sky-200 hover:text-sky-800"
      >
        Buy More/Upgrade
      </Link>
    </div>
