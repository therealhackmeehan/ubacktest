...
export default function ErrorModal({ closeModal, msg }: ErrorModalProps) {
  ...
  const includePaymentLink =
    ...
    msg.toLowerCase().includes("upgrad");
  ...
  return (
    <ModalLayout closeModal={closeModal}>
      ...
      <textarea
        rows={7}
        className="w-full border-0 border-transparent resize-none bg-white font-mono text-xs text-red-700 dark:bg-black dark:text-red-200"
        readOnly={true}
        value={msg}
      ></textarea>
