    ...
    <div className="flex justify-between bg-slate-100 p-1 mt-1 rounded-lg text-xs shadow-sm">
      <div className="p-2">
        <div className="font-extralight flex justify-between items-center">
          started{" "}
          <span className="font-bold tracking-tight text-slate-700 px-2">
      ...
      <div className="p-2 text-sky-800">
        <div className="font-extralight flex justify-between items-center">
          trading cost @{" "}
          <span className="font-bold tracking-tight text-sky-700 px-2">
            {formInputs.costPerTrade}%
          </span>
        </div>
      </div>
      {eodFreqs.includes(formInputs.intval) && (
        <div className="p-2 text-sky-800">
          <div className="font-extralight flex justify-between items-center">
            Using a adjusted close prices?{" "}
            <span className="font-bold tracking-tight text-sky-700 px-2">
              {formInputs.useAdjClose ? "Y" : "N"}
            </span>
          </div>
        </div>
      )}
      <div className="p-2 text-sky-800">
        <div className="font-extralight flex justify-between items-center">
          ...
          <span className="font-bold tracking-tight text-sky-700 px-2">
            {formInputs.useWarmupDate ? "Y" : "N"}
          </span>
        </div>
        <div className="font-extralight flex justify-between items-center">
          burn-in start @{" "}
          <span className="font-bold tracking-tight text-sky-700 px-2">
            {formInputs.useWarmupDate ? formInputs.warmupDate : "N/A"}
          </span>
        </div>
      </div>
    </div>
