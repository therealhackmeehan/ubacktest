  ...
  useEffect(() => {
    const handleMove = (e: MouseEvent | TouchEvent) => {
      ...
      setWidth((previousWidth) => {
        const deltaX = (e as MouseEvent).movementX
          ? (e as MouseEvent).movementX / 2
          : 0;
        const newWidth = (e as TouchEvent).touches
          ? clientX
          : previousWidth + deltaX;
  ...
  return (
    <div className="w-full h-screen grid grid-cols-[min-content_auto] border-t-2 border-black">
      <div className="flex overflow-x-hidden">
        <div
          className="h-full bg-gray-50 dark:bg-boxdark overflow-y-auto"
        ...
        <div
          className="w-3 cursor-col-resize border-r-2 border-black bg-slate-200 dark:bg-black dark:text-white z-10"
...
function NoStrategiesBanner({
  ...
  return (
    <div className="overflow-y-hidden h-full bg-blue-300/20">
      <div className="font-bold font-mono select-none text-center mt-12 px-2 w-fit mx-auto text-2xl text-slate-800 animate-pulse tracking-tight dark:text-white dark:border-white">
        {isStrategiesLoading ? (
          "Loading..."
        ) : (
          <Typewriter
