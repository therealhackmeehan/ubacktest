...
export const features = [
  {
    ...
    description:
      "No need to learn a new scripting language—leverage the full power of Python and Pandas right away.",
    icon: FaPython,
  },
  {
    name: "Stock Data Included",
    description:
      "Simply choose a time range and ticker—no need to deal with costly, outdated options or local setups.",
    icon: BsDatabase,
  },
  {
  ...
  },
  {
    ...
    description:
      "Easily store, track, and refine your trading strategies—or share them with others.",
    icon: FaSave,
  },
  // {
  ...
  // },
  {
    ...
    description:
      "Get started instantly with pre-integrated examples—just press go and see them in action.",
    icon: SiReadthedocs,
  },
  {
    name: "Fully Customizable Backtesting",
    description:
      "Define your stock, date range, trading costs, and more for tailored backtesting.",
    icon: AiTwotoneExperiment,
  },
  {
    name: "Import & Export Python Scripts",
    description:
      "Develop anywhere, then bring your scripts back for seamless backtesting and refinement.",
